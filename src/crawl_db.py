...
# Database file location - writable even when running as a frozen exe
import os, sys as _sys
_app_dir = os.path.dirname(_sys.executable) if getattr(_sys, 'frozen', False) else os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DB_FILE = os.path.join(_app_dir, 'data', 'users.db')

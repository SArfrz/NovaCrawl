...
SMTP_FROM = get_env('SMTP_FROM', 'noreply@NovaCrawl.com')
SMTP_FROM_NAME = get_env('SMTP_FROM_NAME', 'NovaCrawl')

# App URLs
MAIN_APP_URL = get_env('MAIN_APP_URL', 'https://crawl.NovaCrawl.com')
WORKSHOP_APP_URL = get_env('WORKSHOP_APP_URL', 'https://workshop.NovaCrawl.com')
...
def send_verification_email(to_email: str, username: str, token: str, app_source: str = 'main', is_resend: bool = False) -> Tuple[bool, str]:
    ...
    try:
        ...
        if app_source == 'workshop':
            app_name = "NovaCrawl Plugin Workshop"

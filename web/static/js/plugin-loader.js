...
class PluginLoader {
    ...
    /**
     * Register a plugin (called by plugin files via NovaCrawlPlugin.register())
     */
...
console.log('🔌 NovaCrawl Plugin System loaded');
